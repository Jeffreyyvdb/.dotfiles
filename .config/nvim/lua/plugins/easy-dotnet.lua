return {
  ...
  -- Disable OmniSharp since easy-dotnet's Roslyn LSP replaces it
  {
  ...
  -- Neo-tree integration for dotnet file creation (press R in file tree)
  {
